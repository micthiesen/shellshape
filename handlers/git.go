...
func init() {
	shellshape.Register("git", handleGit, shellshape.HandlerOptions{HasSubcommands: true})
}
...
func handleGit(subcommand string, tokens []string) []string {
	...
	categories := []shellshape.FlagCategory{
		{Flags: msgFlags, Placeholder: "<str>"},
	...
	fusedCategories := []shellshape.FlagCategory{
		{Flags: eqValFlags, Placeholder: "<val>"},
		{Flags: valFlags, Placeholder: "<val>"},
		{Flags: msgFlags, Placeholder: "<val>"},
		{Flags: pathFlags, Placeholder: "<val>"},
		{Flags: numericFlags, Placeholder: "<val>"},
	}
	...
	for i < len(args) {
		...
		if norm, ok := shellshape.ConsumeFusedFlag(tok, fusedCategories); ok {
